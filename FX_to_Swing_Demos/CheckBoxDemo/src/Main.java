...
public class Main {
	private static final String TITLE = "Checkbox Demo";
	private static final String[] LIST = {"Web", "Desktop", "Mobile"};
	...
	public static JFrame setupFrame(JFrame frame, int onExit) {
		...
		JLabel lab1 = new JLabel("Select App Deployment Options", JLabel.CENTER);		
		JLabel eventLabel = new JLabel("Test1", JLabel.CENTER);
		JLabel listLabel = new JLabel("Test2", JLabel.CENTER);		
		
		CheckBoxControl control = new CheckBoxControl(LIST, eventLabel, listLabel);
